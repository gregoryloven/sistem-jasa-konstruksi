            ...
            <div class="row">
                <div class="col">
                    <div class="site-logo-wrap">
                        <div class="site-logo">
                            <a href="index.html"><img src="../../enduser/img/logo.png" alt="Logo"></a>
                        </div>
                                ...
                                <ul>
                                    <li class="menu-icon"><a href="#">Home</a>
                                        <ul class="sub-menu menu-pages-img-show">
                                            <li>
                                                ...
                                                <img src="../../enduser/img/home-demos/home-1.jpg" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-2.html">Home Style 02</a>
                                                <img src="../../enduser/img/home-demos/home-2.jpg" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-3.html">Home Style 03</a>
                                                <img src="../../enduser/img/home-demos/home-3.jpg" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-4.html">Home Style 04</a>
                                                <img src="../../enduser/img/home-demos/home-4.jpg" alt="#">
                                            </li>
                                            <li>
                                                <a href="index-5.html">Home Style 05 <span class="menu-item-badge">video</span></a>
                                                <img src="../../enduser/img/home-demos/home-5.jpg" alt="#">
                                            </li>
                                            <li>
                                    ...
                                    <li class="menu-icon"><a href="#">Pages</a>
                                        <ul class="mega-menu">
                                            ...
                                            <li><a href="shop.html"><img src="../../enduser/img/banner/menu-banner-1.jpg" alt="#"></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><a href="contact.html">Contact</a></li>
